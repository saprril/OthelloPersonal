...
using OthelloPersonal.Backend;
using OthelloPersonal.UI;
    ...
    static void Main(string[] args)
    {
        ...
        */
        ...
        while (running)
        {
            ...
            {
                Position cpuPrevMove = new Position();
                while (!othelloControl.IsGameOver())
                {
                    ...
                    do
                    {
                        ...
                        Console.WriteLine($"CPU Previous Move: {cpuPrevMove}");
                    ...
                    if (currentPlayerValidMoves.Count != 0)
                    {
                        cpuPrevMove = currentPlayerValidMoves[rand.Next(currentPlayerValidMoves.Count)];
                        othelloControl.MakeMove(cpuPrevMove, playerList[currentPlayerIdx + 1].PlayerPiece);
                    }
                    else
                    {
                        cpuPrevMove = new Position { Column = -1, Row = -1 };
                    }
